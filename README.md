...
| <a name="input_database"></a> [database](#input\_database) | The name of the mysql database to access. | `string` | n/a | yes |
...
| <a name="output_password"></a> [password](#output\_password) | The password of mysql service. |
<!-- END_TF_DOCS -->
